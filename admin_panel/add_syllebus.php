  ...
  if(!empty($_POST)){
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $query = mysqli_query($con,"insert into `syllebus`(`file_names`,`pdf`,`created_at`)values('$file_names','$file_name','$date')");
        if($query){
          echo "<script>alert('Pdf Has Been Upload Successfully.'); location.replace('view_syllebus.php');</script>";
        }
      } else {
