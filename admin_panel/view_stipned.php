                ...
                <table class="table" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_stipned.php?id=<?php echo $row['id'];?>"><button class="btn btn-sm btn-success">Edit</button></a>
                            <a href="delete_stipned.php?id=<?php echo $row['id'];?>"><button class="btn btn-sm btn-danger">Delete</button></a>
                        </td>
                    </tr>
                    <?php
                        }
