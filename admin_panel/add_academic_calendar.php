  ...
  if(!empty($_POST)){
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $query = mysqli_query($con,"insert into `academic_calendars`(`file_names`,`pdf`,`created_at`)values('$file_names','$file_name','$date')");
        if($query){
          echo "<script>alert('Pdf Has Been Upload Successfully.'); location.replace('view_academic_calendar.php');</script>";
        }
      } else {
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Add Academic Calendar</label>
