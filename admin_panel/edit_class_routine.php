<?php
  ...
  if(!empty($_POST)){
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $update = mysqli_query($con, "update class_routines set file_names='$file_names', pdf='$file_name' where id='$id'");
        if ($update){
            echo "<script>alert('data has been updated successfully.'); location.replace('view_class_routine.php');</script>";
        }
    } else {
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <?php
                $id = $_GET['id'];
                $result = mysqli_query($con, "select * from class_routines where id='$id'");
